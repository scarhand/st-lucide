...
import { FlagTriangleLeft as LucideFlagTriangleLeft, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-flag-triangle-left'
})
export class IconFlagTriangleLeft {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFlagTriangleLeft);
