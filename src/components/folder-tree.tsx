...
import { FolderTree as LucideFolderTree, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-tree'
})
export class IconFolderTree {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderTree);
