...
import { ClipboardEdit as LucideClipboardEdit, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-clipboard-edit'
})
export class IconClipboardEdit {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideClipboardEdit);
