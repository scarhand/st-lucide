...
import { MegaphoneOff as LucideMegaphoneOff, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-megaphone-off'
})
export class IconMegaphoneOff {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMegaphoneOff);
