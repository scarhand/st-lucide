...
import { StickyNote as LucideStickyNote, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-sticky-note'
})
export class IconStickyNote {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideStickyNote);
