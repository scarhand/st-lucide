...
import { AlignEndHorizontal as LucideAlignEndHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-end-horizontal'
})
export class IconAlignEndHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignEndHorizontal);
