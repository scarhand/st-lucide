...
import { Paintbrush2 as LucidePaintbrush2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-paintbrush-2'
})
export class IconPaintbrush2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucidePaintbrush2);
