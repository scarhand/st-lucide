...
import { FolderLock as LucideFolderLock, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-lock'
})
export class IconFolderLock {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderLock);
