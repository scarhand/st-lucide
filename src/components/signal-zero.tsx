...
import { SignalZero as LucideSignalZero, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-signal-zero'
})
export class IconSignalZero {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSignalZero);
