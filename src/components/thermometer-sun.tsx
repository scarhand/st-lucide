...
import { ThermometerSun as LucideThermometerSun, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-thermometer-sun'
})
export class IconThermometerSun {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideThermometerSun);
