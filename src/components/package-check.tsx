...
import { PackageCheck as LucidePackageCheck, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-package-check'
})
export class IconPackageCheck {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucidePackageCheck);
