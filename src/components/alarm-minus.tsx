...
import { AlarmMinus as LucideAlarmMinus, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-alarm-minus'
})
export class IconAlarmMinus {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlarmMinus);
