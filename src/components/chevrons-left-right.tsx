...
import { ChevronsLeftRight as LucideChevronsLeftRight, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-chevrons-left-right'
})
export class IconChevronsLeftRight {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideChevronsLeftRight);
