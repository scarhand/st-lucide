...
import { ArchiveRestore as LucideArchiveRestore, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-archive-restore'
})
export class IconArchiveRestore {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideArchiveRestore);
