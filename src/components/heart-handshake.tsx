...
import { HeartHandshake as LucideHeartHandshake, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-heart-handshake'
})
export class IconHeartHandshake {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideHeartHandshake);
