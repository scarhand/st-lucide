...
import { PartyPopper as LucidePartyPopper, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-party-popper'
})
export class IconPartyPopper {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucidePartyPopper);
