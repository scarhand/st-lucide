...
import { GitPullRequestClosed as LucideGitPullRequestClosed, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-git-pull-request-closed'
})
export class IconGitPullRequestClosed {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideGitPullRequestClosed);
