...
import { FileSearch as LucideFileSearch, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-search'
})
export class IconFileSearch {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileSearch);
