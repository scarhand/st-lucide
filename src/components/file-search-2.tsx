...
import { FileSearch2 as LucideFileSearch2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-search-2'
})
export class IconFileSearch2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileSearch2);
