...
import { CloudSunRain as LucideCloudSunRain, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-cloud-sun-rain'
})
export class IconCloudSunRain {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCloudSunRain);
