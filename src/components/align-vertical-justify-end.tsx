...
import { AlignVerticalJustifyEnd as LucideAlignVerticalJustifyEnd, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-vertical-justify-end'
})
export class IconAlignVerticalJustifyEnd {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignVerticalJustifyEnd);
