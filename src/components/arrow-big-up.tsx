...
import { ArrowBigUp as LucideArrowBigUp, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-arrow-big-up'
})
export class IconArrowBigUp {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideArrowBigUp);
