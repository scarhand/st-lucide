...
import { CigaretteOff as LucideCigaretteOff, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-cigarette-off'
})
export class IconCigaretteOff {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCigaretteOff);
