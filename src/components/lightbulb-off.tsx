...
import { LightbulbOff as LucideLightbulbOff, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-lightbulb-off'
})
export class IconLightbulbOff {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideLightbulbOff);
