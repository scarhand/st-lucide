...
import { FolderCheck as LucideFolderCheck, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-check'
})
export class IconFolderCheck {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderCheck);
