...
import { ConciergeBell as LucideConciergeBell, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-concierge-bell'
})
export class IconConciergeBell {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideConciergeBell);
