...
import { MoveHorizontal as LucideMoveHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-move-horizontal'
})
export class IconMoveHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMoveHorizontal);
