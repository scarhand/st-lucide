...
import { IndianRupee as LucideIndianRupee, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-indian-rupee'
})
export class IconIndianRupee {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideIndianRupee);
