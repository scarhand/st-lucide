...
import { MoveVertical as LucideMoveVertical, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-move-vertical'
})
export class IconMoveVertical {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMoveVertical);
