...
import { Stethoscope as LucideStethoscope, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-stethoscope'
})
export class IconStethoscope {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideStethoscope);
