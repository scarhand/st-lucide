...
import { SwissFranc as LucideSwissFranc, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-swiss-franc'
})
export class IconSwissFranc {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSwissFranc);
