...
import { ShieldClose as LucideShieldClose, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-shield-close'
})
export class IconShieldClose {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideShieldClose);
