...
import { AlignHorizontalDistributeStart as LucideAlignHorizontalDistributeStart, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-horizontal-distribute-start'
})
export class IconAlignHorizontalDistributeStart {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignHorizontalDistributeStart);
