...
import { ChevronsDownUp as LucideChevronsDownUp, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-chevrons-down-up'
})
export class IconChevronsDownUp {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideChevronsDownUp);
