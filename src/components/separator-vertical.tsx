...
import { SeparatorVertical as LucideSeparatorVertical, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-separator-vertical'
})
export class IconSeparatorVertical {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSeparatorVertical);
