...
import { ListOrdered as LucideListOrdered, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-list-ordered'
})
export class IconListOrdered {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideListOrdered);
