...
import { AlignVerticalDistributeEnd as LucideAlignVerticalDistributeEnd, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-vertical-distribute-end'
})
export class IconAlignVerticalDistributeEnd {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignVerticalDistributeEnd);
