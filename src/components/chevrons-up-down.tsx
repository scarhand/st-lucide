...
import { ChevronsUpDown as LucideChevronsUpDown, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-chevrons-up-down'
})
export class IconChevronsUpDown {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideChevronsUpDown);
