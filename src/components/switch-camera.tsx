...
import { SwitchCamera as LucideSwitchCamera, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-switch-camera'
})
export class IconSwitchCamera {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSwitchCamera);
