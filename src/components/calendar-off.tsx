...
import { CalendarOff as LucideCalendarOff, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-off'
})
export class IconCalendarOff {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarOff);
