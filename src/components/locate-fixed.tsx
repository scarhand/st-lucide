...
import { LocateFixed as LucideLocateFixed, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-locate-fixed'
})
export class IconLocateFixed {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideLocateFixed);
