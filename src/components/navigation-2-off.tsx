...
import { Navigation2Off as LucideNavigation2Off, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-navigation-2-off'
})
export class IconNavigation2Off {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideNavigation2Off);
