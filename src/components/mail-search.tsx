...
import { MailSearch as LucideMailSearch, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-mail-search'
})
export class IconMailSearch {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMailSearch);
