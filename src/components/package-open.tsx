...
import { PackageOpen as LucidePackageOpen, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-package-open'
})
export class IconPackageOpen {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucidePackageOpen);
