...
import { FileBarChart2 as LucideFileBarChart2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-bar-chart-2'
})
export class IconFileBarChart2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileBarChart2);
