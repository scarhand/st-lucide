...
import { FlipHorizontal2 as LucideFlipHorizontal2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-flip-horizontal-2'
})
export class IconFlipHorizontal2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFlipHorizontal2);
