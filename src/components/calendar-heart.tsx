...
import { CalendarHeart as LucideCalendarHeart, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-heart'
})
export class IconCalendarHeart {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarHeart);
