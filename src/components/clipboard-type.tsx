...
import { ClipboardType as LucideClipboardType, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-clipboard-type'
})
export class IconClipboardType {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideClipboardType);
