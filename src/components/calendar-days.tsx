...
import { CalendarDays as LucideCalendarDays, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-days'
})
export class IconCalendarDays {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarDays);
