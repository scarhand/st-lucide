...
import { CalendarCheck2 as LucideCalendarCheck2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-check-2'
})
export class IconCalendarCheck2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarCheck2);
