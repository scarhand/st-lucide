...
import { CalendarSearch as LucideCalendarSearch, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-search'
})
export class IconCalendarSearch {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarSearch);
