...
import { LayoutDashboard as LucideLayoutDashboard, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-layout-dashboard'
})
export class IconLayoutDashboard {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideLayoutDashboard);
