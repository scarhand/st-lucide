...
import { GitPullRequestDraft as LucideGitPullRequestDraft, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-git-pull-request-draft'
})
export class IconGitPullRequestDraft {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideGitPullRequestDraft);
