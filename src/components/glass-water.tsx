...
import { GlassWater as LucideGlassWater, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-glass-water'
})
export class IconGlassWater {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideGlassWater);
