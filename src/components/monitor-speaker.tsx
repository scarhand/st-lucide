...
import { MonitorSpeaker as LucideMonitorSpeaker, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-monitor-speaker'
})
export class IconMonitorSpeaker {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMonitorSpeaker);
