...
import { ClipboardX as LucideClipboardX, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-clipboard-x'
})
export class IconClipboardX {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideClipboardX);
