...
import { FileSignature as LucideFileSignature, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-signature'
})
export class IconFileSignature {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileSignature);
