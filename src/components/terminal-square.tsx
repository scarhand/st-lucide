...
import { TerminalSquare as LucideTerminalSquare, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-terminal-square'
})
export class IconTerminalSquare {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideTerminalSquare);
