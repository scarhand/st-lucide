...
import { AlignHorizontalDistributeEnd as LucideAlignHorizontalDistributeEnd, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-horizontal-distribute-end'
})
export class IconAlignHorizontalDistributeEnd {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignHorizontalDistributeEnd);
