...
import { CircleSlashed as LucideCircleSlashed, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-circle-slashed'
})
export class IconCircleSlashed {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCircleSlashed);
