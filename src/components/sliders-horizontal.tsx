...
import { SlidersHorizontal as LucideSlidersHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-sliders-horizontal'
})
export class IconSlidersHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSlidersHorizontal);
