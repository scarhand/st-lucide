...
import { CurlyBraces as LucideCurlyBraces, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-curly-braces'
})
export class IconCurlyBraces {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCurlyBraces);
