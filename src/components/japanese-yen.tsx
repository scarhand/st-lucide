...
import { JapaneseYen as LucideJapaneseYen, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-japanese-yen'
})
export class IconJapaneseYen {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideJapaneseYen);
