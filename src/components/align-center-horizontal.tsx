...
import { AlignCenterHorizontal as LucideAlignCenterHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-center-horizontal'
})
export class IconAlignCenterHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignCenterHorizontal);
