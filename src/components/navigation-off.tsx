...
import { NavigationOff as LucideNavigationOff, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-navigation-off'
})
export class IconNavigationOff {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideNavigationOff);
