...
import { PersonStanding as LucidePersonStanding, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-person-standing'
})
export class IconPersonStanding {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucidePersonStanding);
