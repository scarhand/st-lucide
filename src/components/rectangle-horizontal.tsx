...
import { RectangleHorizontal as LucideRectangleHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-rectangle-horizontal'
})
export class IconRectangleHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideRectangleHorizontal);
