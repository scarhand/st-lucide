...
import { AlignHorizontalSpaceAround as LucideAlignHorizontalSpaceAround, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-horizontal-space-around'
})
export class IconAlignHorizontalSpaceAround {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignHorizontalSpaceAround);
