...
import { FolderSymlink as LucideFolderSymlink, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-symlink'
})
export class IconFolderSymlink {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderSymlink);
