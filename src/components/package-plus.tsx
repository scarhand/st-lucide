...
import { PackagePlus as LucidePackagePlus, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-package-plus'
})
export class IconPackagePlus {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucidePackagePlus);
