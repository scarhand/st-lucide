...
import { FlaskConical as LucideFlaskConical, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-flask-conical'
})
export class IconFlaskConical {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFlaskConical);
