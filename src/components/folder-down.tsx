...
import { FolderDown as LucideFolderDown, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-down'
})
export class IconFolderDown {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderDown);
