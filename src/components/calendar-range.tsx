...
import { CalendarRange as LucideCalendarRange, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-range'
})
export class IconCalendarRange {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarRange);
