...
import { FolderClock as LucideFolderClock, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-clock'
})
export class IconFolderClock {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderClock);
