...
import { ShowerHead as LucideShowerHead, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-shower-head'
})
export class IconShowerHead {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideShowerHead);
