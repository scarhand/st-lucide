...
import { AlignHorizontalJustifyCenter as LucideAlignHorizontalJustifyCenter, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-horizontal-justify-center'
})
export class IconAlignHorizontalJustifyCenter {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignHorizontalJustifyCenter);
