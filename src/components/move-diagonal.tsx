...
import { MoveDiagonal as LucideMoveDiagonal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-move-diagonal'
})
export class IconMoveDiagonal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMoveDiagonal);
