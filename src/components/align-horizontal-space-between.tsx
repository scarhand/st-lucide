...
import { AlignHorizontalSpaceBetween as LucideAlignHorizontalSpaceBetween, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-horizontal-space-between'
})
export class IconAlignHorizontalSpaceBetween {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignHorizontalSpaceBetween);
