...
import { BatteryLow as LucideBatteryLow, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-battery-low'
})
export class IconBatteryLow {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideBatteryLow);
