...
import { PackageSearch as LucidePackageSearch, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-package-search'
})
export class IconPackageSearch {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucidePackageSearch);
