...
import { AlignHorizontalJustifyStart as LucideAlignHorizontalJustifyStart, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-horizontal-justify-start'
})
export class IconAlignHorizontalJustifyStart {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignHorizontalJustifyStart);
