...
import { UtensilsCrossed as LucideUtensilsCrossed, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-utensils-crossed'
})
export class IconUtensilsCrossed {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideUtensilsCrossed);
