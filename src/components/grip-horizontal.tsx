...
import { GripHorizontal as LucideGripHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-grip-horizontal'
})
export class IconGripHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideGripHorizontal);
