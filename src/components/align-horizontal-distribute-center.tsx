...
import { AlignHorizontalDistributeCenter as LucideAlignHorizontalDistributeCenter, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-horizontal-distribute-center'
})
export class IconAlignHorizontalDistributeCenter {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignHorizontalDistributeCenter);
