...
import { PoundSterling as LucidePoundSterling, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-pound-sterling'
})
export class IconPoundSterling {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucidePoundSterling);
