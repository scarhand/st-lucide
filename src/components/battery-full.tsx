...
import { BatteryFull as LucideBatteryFull, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-battery-full'
})
export class IconBatteryFull {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideBatteryFull);
