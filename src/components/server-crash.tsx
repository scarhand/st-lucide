...
import { ServerCrash as LucideServerCrash, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-server-crash'
})
export class IconServerCrash {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideServerCrash);
