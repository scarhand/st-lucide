...
import { AlignVerticalDistributeCenter as LucideAlignVerticalDistributeCenter, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-vertical-distribute-center'
})
export class IconAlignVerticalDistributeCenter {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignVerticalDistributeCenter);
