...
import { BookOpenCheck as LucideBookOpenCheck, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-book-open-check'
})
export class IconBookOpenCheck {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideBookOpenCheck);
