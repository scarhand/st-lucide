...
import { PauseOctagon as LucidePauseOctagon, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-pause-octagon'
})
export class IconPauseOctagon {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucidePauseOctagon);
