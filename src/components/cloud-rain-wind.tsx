...
import { CloudRainWind as LucideCloudRainWind, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-cloud-rain-wind'
})
export class IconCloudRainWind {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCloudRainWind);
