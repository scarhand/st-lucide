...
import { FolderEdit as LucideFolderEdit, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-edit'
})
export class IconFolderEdit {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderEdit);
