...
import { FileAxis3d as LucideFileAxis3d, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-axis-3d'
})
export class IconFileAxis3d {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileAxis3d);
