...
import { MailWarning as LucideMailWarning, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-mail-warning'
})
export class IconMailWarning {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMailWarning);
