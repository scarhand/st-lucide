...
export class CornerDownRight {
  ...
  render() {
    return <Host innerHTML={feather.icons['corner-down-right'].toSvg({...attributesToObject(this.el), ...this.getProps()})} class="st-feather-icon"></Host>;
  }
