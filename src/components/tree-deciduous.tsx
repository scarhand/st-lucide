...
import { TreeDeciduous as LucideTreeDeciduous, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-tree-deciduous'
})
export class IconTreeDeciduous {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideTreeDeciduous);
