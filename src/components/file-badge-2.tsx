...
import { FileBadge2 as LucideFileBadge2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-badge-2'
})
export class IconFileBadge2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileBadge2);
