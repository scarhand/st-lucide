...
import { FileCheck2 as LucideFileCheck2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-check-2'
})
export class IconFileCheck2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileCheck2);
