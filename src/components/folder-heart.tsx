...
import { FolderHeart as LucideFolderHeart, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-heart'
})
export class IconFolderHeart {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderHeart);
