...
import { Refrigerator as LucideRefrigerator, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-refrigerator'
})
export class IconRefrigerator {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideRefrigerator);
