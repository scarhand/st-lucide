...
import { FolderSearch as LucideFolderSearch, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-search'
})
export class IconFolderSearch {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderSearch);
