...
import { FileOutput as LucideFileOutput, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-output'
})
export class IconFileOutput {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileOutput);
