...
import { FlagTriangleRight as LucideFlagTriangleRight, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-flag-triangle-right'
})
export class IconFlagTriangleRight {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFlagTriangleRight);
