...
import { FileWarning as LucideFileWarning, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-warning'
})
export class IconFileWarning {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileWarning);
