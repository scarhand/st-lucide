...
import { AlignVerticalSpaceBetween as LucideAlignVerticalSpaceBetween, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-vertical-space-between'
})
export class IconAlignVerticalSpaceBetween {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignVerticalSpaceBetween);
