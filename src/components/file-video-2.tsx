...
import { FileVideo2 as LucideFileVideo2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-video-2'
})
export class IconFileVideo2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileVideo2);
