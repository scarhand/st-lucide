...
import { CalendarCheck as LucideCalendarCheck, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-check'
})
export class IconCalendarCheck {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarCheck);
