...
import { FileLineChart as LucideFileLineChart, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-line-chart'
})
export class IconFileLineChart {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileLineChart);
