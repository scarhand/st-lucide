...
import { BookmarkMinus as LucideBookmarkMinus, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-bookmark-minus'
})
export class IconBookmarkMinus {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideBookmarkMinus);
