...
import { MailQuestion as LucideMailQuestion, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-mail-question'
})
export class IconMailQuestion {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMailQuestion);
