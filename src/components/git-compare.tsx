...
import { GitCompare as LucideGitCompare, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-git-compare'
})
export class IconGitCompare {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideGitCompare);
