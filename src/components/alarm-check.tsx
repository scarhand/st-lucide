...
import { AlarmCheck as LucideAlarmCheck, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-alarm-check'
})
export class IconAlarmCheck {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlarmCheck);
