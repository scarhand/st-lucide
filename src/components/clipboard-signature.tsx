...
import { ClipboardSignature as LucideClipboardSignature, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-clipboard-signature'
})
export class IconClipboardSignature {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideClipboardSignature);
