...
import { GripVertical as LucideGripVertical, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-grip-vertical'
})
export class IconGripVertical {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideGripVertical);
