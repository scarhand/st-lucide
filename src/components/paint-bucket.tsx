...
import { PaintBucket as LucidePaintBucket, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-paint-bucket'
})
export class IconPaintBucket {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucidePaintBucket);
