...
import { MousePointer2 as LucideMousePointer2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-mouse-pointer-2'
})
export class IconMousePointer2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMousePointer2);
