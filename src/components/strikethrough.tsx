...
import { Strikethrough as LucideStrikethrough, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-strikethrough'
})
export class IconStrikethrough {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideStrikethrough);
