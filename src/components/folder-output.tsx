...
import { FolderOutput as LucideFolderOutput, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-output'
})
export class IconFolderOutput {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderOutput);
