...
import { VenetianMask as LucideVenetianMask, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-venetian-mask'
})
export class IconVenetianMask {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideVenetianMask);
