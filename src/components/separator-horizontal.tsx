...
import { SeparatorHorizontal as LucideSeparatorHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-separator-horizontal'
})
export class IconSeparatorHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSeparatorHorizontal);
