...
import { MountainSnow as LucideMountainSnow, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-mountain-snow'
})
export class IconMountainSnow {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMountainSnow);
