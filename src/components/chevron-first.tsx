...
import { ChevronFirst as LucideChevronFirst, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-chevron-first'
})
export class IconChevronFirst {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideChevronFirst);
