...
import { SidebarOpen as LucideSidebarOpen, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-sidebar-open'
})
export class IconSidebarOpen {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSidebarOpen);
