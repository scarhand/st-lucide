...
import { CalendarPlus as LucideCalendarPlus, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-plus'
})
export class IconCalendarPlus {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarPlus);
