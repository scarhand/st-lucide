...
import { FolderSearch2 as LucideFolderSearch2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-search-2'
})
export class IconFolderSearch2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderSearch2);
