...
import { CalendarX2 as LucideCalendarX2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-x-2'
})
export class IconCalendarX2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarX2);
