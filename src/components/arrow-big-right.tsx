...
import { ArrowBigRight as LucideArrowBigRight, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-arrow-big-right'
})
export class IconArrowBigRight {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideArrowBigRight);
