...
import { ShieldAlert as LucideShieldAlert, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-shield-alert'
})
export class IconShieldAlert {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideShieldAlert);
