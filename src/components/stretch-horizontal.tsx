...
import { StretchHorizontal as LucideStretchHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-stretch-horizontal'
})
export class IconStretchHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideStretchHorizontal);
