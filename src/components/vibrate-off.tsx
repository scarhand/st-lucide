...
import { VibrateOff as LucideVibrateOff, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-vibrate-off'
})
export class IconVibrateOff {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideVibrateOff);
