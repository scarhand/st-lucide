...
import { HeartPulse as LucideHeartPulse, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-heart-pulse'
})
export class IconHeartPulse {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideHeartPulse);
