...
import { FileVolume as LucideFileVolume, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-volume'
})
export class IconFileVolume {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileVolume);
