...
import { BaggageClaim as LucideBaggageClaim, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-baggage-claim'
})
export class IconBaggageClaim {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideBaggageClaim);
