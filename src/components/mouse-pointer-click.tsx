...
import { MousePointerClick as LucideMousePointerClick, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-mouse-pointer-click'
})
export class IconMousePointerClick {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMousePointerClick);
