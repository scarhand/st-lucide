...
import { ClipboardCheck as LucideClipboardCheck, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-clipboard-check'
})
export class IconClipboardCheck {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideClipboardCheck);
