...
import { SignalHigh as LucideSignalHigh, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-signal-high'
})
export class IconSignalHigh {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSignalHigh);
