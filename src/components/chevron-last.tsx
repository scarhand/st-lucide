...
import { ChevronLast as LucideChevronLast, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-chevron-last'
})
export class IconChevronLast {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideChevronLast);
