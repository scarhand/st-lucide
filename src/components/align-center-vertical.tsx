...
import { AlignCenterVertical as LucideAlignCenterVertical, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-center-vertical'
})
export class IconAlignCenterVertical {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignCenterVertical);
