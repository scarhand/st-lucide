...
import { MoveDiagonal2 as LucideMoveDiagonal2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-move-diagonal-2'
})
export class IconMoveDiagonal2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMoveDiagonal2);
