...
import { LampWallDown as LucideLampWallDown, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-lamp-wall-down'
})
export class IconLampWallDown {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideLampWallDown);
