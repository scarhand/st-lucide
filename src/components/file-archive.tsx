...
import { FileArchive as LucideFileArchive, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-archive'
})
export class IconFileArchive {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileArchive);
