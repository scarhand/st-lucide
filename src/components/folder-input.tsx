...
import { FolderInput as LucideFolderInput, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-input'
})
export class IconFolderInput {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderInput);
