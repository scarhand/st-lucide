...
import { ArrowUpDown as LucideArrowUpDown, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-arrow-up-down'
})
export class IconArrowUpDown {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideArrowUpDown);
