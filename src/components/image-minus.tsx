...
import { ImageMinus as LucideImageMinus, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-image-minus'
})
export class IconImageMinus {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideImageMinus);
