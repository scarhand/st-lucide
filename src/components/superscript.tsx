...
import { Superscript as LucideSuperscript, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-superscript'
})
export class IconSuperscript {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSuperscript);
