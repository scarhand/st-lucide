...
import { Codesandbox as LucideCodesandbox, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-codesandbox'
})
export class IconCodesandbox {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCodesandbox);
