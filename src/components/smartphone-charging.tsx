...
import { SmartphoneCharging as LucideSmartphoneCharging, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-smartphone-charging'
})
export class IconSmartphoneCharging {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSmartphoneCharging);
