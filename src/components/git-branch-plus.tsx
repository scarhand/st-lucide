...
import { GitBranchPlus as LucideGitBranchPlus, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-git-branch-plus'
})
export class IconGitBranchPlus {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideGitBranchPlus);
