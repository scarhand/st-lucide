...
import { FlipVertical as LucideFlipVertical, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-flip-vertical'
})
export class IconFlipVertical {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFlipVertical);
