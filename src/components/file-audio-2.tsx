...
import { FileAudio2 as LucideFileAudio2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-audio-2'
})
export class IconFileAudio2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileAudio2);
