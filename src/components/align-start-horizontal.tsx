...
import { AlignStartHorizontal as LucideAlignStartHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-start-horizontal'
})
export class IconAlignStartHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignStartHorizontal);
