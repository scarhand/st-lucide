...
import { FileMinus2 as LucideFileMinus2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-minus-2'
})
export class IconFileMinus2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileMinus2);
