...
import { CloudMoonRain as LucideCloudMoonRain, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-cloud-moon-rain'
})
export class IconCloudMoonRain {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCloudMoonRain);
