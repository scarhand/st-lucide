...
import { CalendarClock as LucideCalendarClock, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-clock'
})
export class IconCalendarClock {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarClock);
