...
import { SignalMedium as LucideSignalMedium, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-signal-medium'
})
export class IconSignalMedium {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSignalMedium);
