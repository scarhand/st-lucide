...
import { BarChartHorizontal as LucideBarChartHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-bar-chart-horizontal'
})
export class IconBarChartHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideBarChartHorizontal);
