...
import { HeartCrack as LucideHeartCrack, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-heart-crack'
})
export class IconHeartCrack {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideHeartCrack);
