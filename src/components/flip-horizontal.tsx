...
import { FlipHorizontal as LucideFlipHorizontal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-flip-horizontal'
})
export class IconFlipHorizontal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFlipHorizontal);
