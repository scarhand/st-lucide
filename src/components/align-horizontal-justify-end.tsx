...
import { AlignHorizontalJustifyEnd as LucideAlignHorizontalJustifyEnd, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-horizontal-justify-end'
})
export class IconAlignHorizontalJustifyEnd {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignHorizontalJustifyEnd);
