...
import { AlignVerticalDistributeStart as LucideAlignVerticalDistributeStart, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-vertical-distribute-start'
})
export class IconAlignVerticalDistributeStart {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignVerticalDistributeStart);
