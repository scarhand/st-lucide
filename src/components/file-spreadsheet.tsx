...
import { FileSpreadsheet as LucideFileSpreadsheet, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-spreadsheet'
})
export class IconFileSpreadsheet {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileSpreadsheet);
