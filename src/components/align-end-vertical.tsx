...
import { AlignEndVertical as LucideAlignEndVertical, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-end-vertical'
})
export class IconAlignEndVertical {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignEndVertical);
