...
import { AlignVerticalSpaceAround as LucideAlignVerticalSpaceAround, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-vertical-space-around'
})
export class IconAlignVerticalSpaceAround {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignVerticalSpaceAround);
