...
import { FunctionSquare as LucideFunctionSquare, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-function-square'
})
export class IconFunctionSquare {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFunctionSquare);
