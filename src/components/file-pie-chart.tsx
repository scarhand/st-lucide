...
import { FilePieChart as LucideFilePieChart, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-pie-chart'
})
export class IconFilePieChart {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFilePieChart);
