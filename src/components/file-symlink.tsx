...
import { FileSymlink as LucideFileSymlink, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-symlink'
})
export class IconFileSymlink {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileSymlink);
