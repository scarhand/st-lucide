...
import { ScreenShare as LucideScreenShare, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-screen-share'
})
export class IconScreenShare {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideScreenShare);
