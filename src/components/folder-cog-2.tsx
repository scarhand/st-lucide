...
import { FolderCog2 as LucideFolderCog2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-cog-2'
})
export class IconFolderCog2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderCog2);
