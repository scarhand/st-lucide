...
import { FolderClosed as LucideFolderClosed, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-closed'
})
export class IconFolderClosed {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderClosed);
