...
import { ArrowBigDown as LucideArrowBigDown, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-arrow-big-down'
})
export class IconArrowBigDown {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideArrowBigDown);
