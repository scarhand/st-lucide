...
import { FolderArchive as LucideFolderArchive, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-folder-archive'
})
export class IconFolderArchive {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFolderArchive);
