...
import { LayoutGrid as LucideLayoutGrid, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-layout-grid'
})
export class IconLayoutGrid {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideLayoutGrid);
