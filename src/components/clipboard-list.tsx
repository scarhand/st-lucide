...
import { ClipboardList as LucideClipboardList, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-clipboard-list'
})
export class IconClipboardList {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideClipboardList);
