...
import { ScreenShareOff as LucideScreenShareOff, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-screen-share-off'
})
export class IconScreenShareOff {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideScreenShareOff);
