...
import { LampCeiling as LucideLampCeiling, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-lamp-ceiling'
})
export class IconLampCeiling {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideLampCeiling);
