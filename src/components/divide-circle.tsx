...
@Component({
  tag: 'icon-divide-circle'
})
export class DivideCircle {
  @Element() el: any;
  ...
  render() {
    return <Host innerHTML={feather.icons['divide-circle'].toSvg({...attributesToObject(this.el), ...this.getProps()})} class="st-feather-icon"></Host>;
  }
