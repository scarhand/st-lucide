...
import { LassoSelect as LucideLassoSelect, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-lasso-select'
})
export class IconLassoSelect {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideLassoSelect);
