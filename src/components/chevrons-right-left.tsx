...
import { ChevronsRightLeft as LucideChevronsRightLeft, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-chevrons-right-left'
})
export class IconChevronsRightLeft {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideChevronsRightLeft);
