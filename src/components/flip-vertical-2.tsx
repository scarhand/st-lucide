...
import { FlipVertical2 as LucideFlipVertical2, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-flip-vertical-2'
})
export class IconFlipVertical2 {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFlipVertical2);
