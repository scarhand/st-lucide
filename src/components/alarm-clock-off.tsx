...
import { AlarmClockOff as LucideAlarmClockOff, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-alarm-clock-off'
})
export class IconAlarmClockOff {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlarmClockOff);
