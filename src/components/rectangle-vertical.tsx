...
import { RectangleVertical as LucideRectangleVertical, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-rectangle-vertical'
})
export class IconRectangleVertical {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideRectangleVertical);
