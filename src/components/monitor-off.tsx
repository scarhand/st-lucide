...
import { MonitorOff as LucideMonitorOff, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-monitor-off'
})
export class IconMonitorOff {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideMonitorOff);
