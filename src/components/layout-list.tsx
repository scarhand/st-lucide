...
import { LayoutList as LucideLayoutList, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-layout-list'
})
export class IconLayoutList {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideLayoutList);
