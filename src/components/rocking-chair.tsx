...
import { RockingChair as LucideRockingChair, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-rocking-chair'
})
export class IconRockingChair {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideRockingChair);
