...
import { BluetoothOff as LucideBluetoothOff, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-bluetooth-off'
})
export class IconBluetoothOff {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideBluetoothOff);
