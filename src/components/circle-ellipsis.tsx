...
import { CircleEllipsis as LucideCircleEllipsis, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-circle-ellipsis'
})
export class IconCircleEllipsis {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCircleEllipsis);
