...
import { AlignVerticalJustifyStart as LucideAlignVerticalJustifyStart, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-vertical-justify-start'
})
export class IconAlignVerticalJustifyStart {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignVerticalJustifyStart);
