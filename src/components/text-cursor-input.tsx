...
import { TextCursorInput as LucideTextCursorInput, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-text-cursor-input'
})
export class IconTextCursorInput {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideTextCursorInput);
