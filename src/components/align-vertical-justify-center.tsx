...
import { AlignVerticalJustifyCenter as LucideAlignVerticalJustifyCenter, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-align-vertical-justify-center'
})
export class IconAlignVerticalJustifyCenter {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideAlignVerticalJustifyCenter);
