...
import { BluetoothSearching as LucideBluetoothSearching, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-bluetooth-searching'
})
export class IconBluetoothSearching {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideBluetoothSearching);
