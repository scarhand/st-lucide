...
import { SidebarClose as LucideSidebarClose, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-sidebar-close'
})
export class IconSidebarClose {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideSidebarClose);
