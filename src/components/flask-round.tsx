...
import { FlaskRound as LucideFlaskRound, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-flask-round'
})
export class IconFlaskRound {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFlaskRound);
