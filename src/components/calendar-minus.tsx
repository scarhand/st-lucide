...
import { CalendarMinus as LucideCalendarMinus, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-calendar-minus'
})
export class IconCalendarMinus {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideCalendarMinus);
