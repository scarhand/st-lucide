...
import { LampWallUp as LucideLampWallUp, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-lamp-wall-up'
})
export class IconLampWallUp {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideLampWallUp);
