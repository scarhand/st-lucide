...
import { FileTerminal as LucideFileTerminal, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-terminal'
})
export class IconFileTerminal {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileTerminal);
