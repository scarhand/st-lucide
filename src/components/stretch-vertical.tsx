...
import { StretchVertical as LucideStretchVertical, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-stretch-vertical'
})
export class IconStretchVertical {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideStretchVertical);
