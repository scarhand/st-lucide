...
import { BookmarkPlus as LucideBookmarkPlus, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-bookmark-plus'
})
export class IconBookmarkPlus {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideBookmarkPlus);
