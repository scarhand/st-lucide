...
import { Clapperboard as LucideClapperboard, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-clapperboard'
})
export class IconClapperboard {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideClapperboard);
