...
import { FileQuestion as LucideFileQuestion, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-question'
})
export class IconFileQuestion {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileQuestion);
