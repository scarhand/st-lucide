...
import { TimerReset as LucideTimerReset, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-timer-reset'
})
export class IconTimerReset {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideTimerReset);
