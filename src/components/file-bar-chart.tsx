...
import { FileBarChart as LucideFileBarChart, createElement } from 'lucide';
import { attributesToObject } from '../utils/utils';

@Component({
  tag: 'icon-file-bar-chart'
})
export class IconFileBarChart {
  @Element() el: any;
  ...
  render() {
    const inner = createElement(LucideFileBarChart);
